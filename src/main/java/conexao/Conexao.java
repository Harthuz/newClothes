...
public class Conexao {
    ...
    final private String url = "jdbc:mysql://localhost/BD_NEWCLOTHES";
    ...
    public int executaUpdate(String sql) {
        ...
        try {
            if (conexao != null) {
                ...
                resultado = statement.executeUpdate(sql); // Executa a atualização e captura o número de linhas afetadas
            } else {
                JOptionPane.showMessageDialog(null, "Conexão não estabelecida!", "Mensagem do Programa", JOptionPane.WARNING_MESSAGE);
            }
        } catch (SQLException e) {
